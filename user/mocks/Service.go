...
import (
	...
	user "github.com/RushikeshMarkad16/Library-Managemant/user"
...
func (_m *Service) Create(ctx context.Context, req user.User) error {
...
// FindByData provides a mock function with given fields: ctx, filterData
func (_m *Service) FindByData(ctx context.Context, filterData string) (user.FindByDataResponse, error) {
	ret := _m.Called(ctx, filterData)

	var r0 user.FindByDataResponse
	if rf, ok := ret.Get(0).(func(context.Context, string) user.FindByDataResponse); ok {
		r0 = rf(ctx, filterData)
	} else {
		r0 = ret.Get(0).(user.FindByDataResponse)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string) error); ok {
		r1 = rf(ctx, filterData)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Service) Update(ctx context.Context, req user.User) error {
	ret := _m.Called(ctx, req)
